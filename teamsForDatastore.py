...
def dataStoreTeams():
    ...
    Team(key_name='Newcastle', teamName='Newcastle United', twitter='@NUFC', youtube='NUFCOfficial1892', lon= -1.621667, lat=54.975593, stadium='St James\' Park', emblem = 'http://upload.wikimedia.org/wikipedia/de/5/56/Newcastle_United_Logo.svg', wikipedia = '203434').put()
